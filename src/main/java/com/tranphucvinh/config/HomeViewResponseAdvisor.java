...
import com.tranphucvinh.controller.home.AboutMeController;
import com.tranphucvinh.controller.home.ContactController;
...
@ControllerAdvice(assignableTypes = { IndexController.class, PostController.class, GalleryController.class,
		AboutMeController.class, ContactController.class, PostsController.class, AppErrorController.class })
public class HomeViewResponseAdvisor {
	...
	@ModelAttribute("fePostsInit")
	public Map<String,Object> fePostsInit() {
		Map<String,Object> params = new HashMap<String,Object>();
		params.put("page", 1);
		params.put("pageSize", 4);
	...
	@ModelAttribute("bePostsInit")
	public Map<String,Object> bePostsInit() {
		Map<String,Object> params = new HashMap<String,Object>();
		params.put("page", 1);
		params.put("pageSize", 4);
